...
## Environments
- Preview: https://main--maji-da-excatops--aemysites.aem.page/
- Live: https://main--maji-da-excatops--aemysites.aem.live/
- Block Library: https://main--maji-da-excatops--aemysites.aem.page/tools/sidekick/library.html?plugin=blocks
...
1. Open the `maji-da-excatops` directory in your favorite IDE and start coding :)
